...
public class LectureDialog extends Dialog {
    ...
    public LectureDialog(@NonNull Context context, final Credit credit) {
        super(context,R.style.LoginDialog);
        setContentView(R.layout.dialog_lecture);
        setTitle("创新创业讲座");
        setCancelable(true);
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.btn_up:
                        ...
                        credit.lecture.setName(name);
                        credit.lecture.setTime(time);
                        credit.lecture.setGrade(addCredit);
                        Log.d("AAA","dialog里头的"+credit.lecture.toString());
                        break;
