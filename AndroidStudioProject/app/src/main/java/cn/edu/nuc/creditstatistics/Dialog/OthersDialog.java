...
public class OthersDialog extends Dialog {
    ...
    public OthersDialog(@NonNull Context context, final Credit credit) {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.btn_up:
                        ...
                        credit.others.setName(name);
                        credit.others.setRemarks(time);
                        credit.others.setGrade(addCredit);
                        Log.d("AAA","dialog里头的"+credit.others.toString());
                        break;
