...
public class GameDialog extends Dialog {
    ...
    public GameDialog(@NonNull Context context, final Credit credit) {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.btn_up:
                        ...
                        credit.game.setGame_name(name);
                        credit.game.setProject_name(time);
                        credit.game.setRank(rank);
                        credit.game.setGrade(addCredit);
                        Log.d("AAA","dialog里头的"+credit.game.toString());
                        break;
