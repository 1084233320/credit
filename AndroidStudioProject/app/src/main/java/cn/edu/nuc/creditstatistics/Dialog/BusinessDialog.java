...
public class BusinessDialog extends Dialog {
    ...
    public BusinessDialog(@NonNull Context context, final Credit credit) {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.btn_up:
                        ...
                        credit.business.setName(name);
                        credit.business.setMoney(time);
                        credit.business.setGrade(addCredit);
                        Log.d("AAA","dialog里头的"+credit.business.toString());
                        break;
