...
public class ReportDialog extends Dialog {
    ...
    public ReportDialog(@NonNull Context context, final Credit credit) {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.btn_up:
                        ...
                        credit.report.setName(name);
                        credit.report.setTime(time);
                        credit.report.setGrade(addCredit);
                        Log.d("AAA","dialog里头的"+credit.report.toString());
                        break;
